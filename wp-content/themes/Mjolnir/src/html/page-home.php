...
<section class="servicos-marketing">
    <div class="servicos-marketing__lista-servicos">
        <div class="servico-bloco">
            <div class="foto-servico">
                <img src="<?php echo get_template_directory_uri() ?>/img/landing-pages.png" alt="Dois computadores que possuem em suas telas, landing pages">
            </div>
        ...
        <div class="servico-bloco">
            <div class="foto-servico">
                <img src="<?php echo get_template_directory_uri() ?>/img/seo-analytics.png" alt="Celular com o google na tela">
            </div>
            <div class="corpo-servico">
                <h5>SEO & Analytics</h5>
        ...
        <div class="servico-bloco">
            <div class="foto-servico">
                <img src="<?php echo get_template_directory_uri() ?>/img/socialmedia.png" alt="Tela de computador com analytics do Google">
            </div>
            <div class="corpo-servico">
    ...
    <aside class="servicos-marketing__aside-servicos">
        <div class="servicos-marketing__aside-servicos__foto-whatever">
